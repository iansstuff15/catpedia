...
class GenInfo extends StatelessWidget {
  ...
  final List<String> bulletPoints = [
    ...
    "Groom them regularly. Longhaired cats require daily grooming",
    ...
    "Take the cat to the vet whenever they show signs of illness",
    "Have an insurance for your cat for their veterinary treatment if ever needed"
  ];
                ...
                child: SingleChildScrollView(
                  child: Padding(
                    ...
                    ClipRRect(
                        ...
                        SizedBox(height: 30),
                        Text(
                          'Generally, when caring for a cat, you will need these:',
                          style: TextStyle(
